...
<head>
  ...
  <meta name="csrf-token" content="nQwd7mFyXoE1dfcjtHRQtWpe0qzqMePZCaSWGPEd">
...
<link rel="stylesheet" type="text/css"
  href="{{ asset('admin/css/themes/vertical-dark-menu-template/materialize.css')}}">
<link rel="stylesheet" type="text/css"
  href="{{ asset('admin/css/themes/vertical-dark-menu-template/style.css')}}">
...
<!-- END: Page Level CSS-->
<!-- BEGIN: Custom CSS-->
<link rel="stylesheet" type="text/css" href="{{ asset('admin/css/laravel-custom.css')}}">
...
<!-- END THEME  JS-->
<!-- BEGIN PAGE LEVEL JS-->
<script src="{{ asset('admin/js/scripts/dashboard-ecommerce.js')}}"></script>
</body>

<!-- Mirrored from www.pixinvent.com/materialize-material-design-admin-template/laravel/demo-4/ecommerce by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 25 Mar 2021 14:22:24 GMT -->
</html>
